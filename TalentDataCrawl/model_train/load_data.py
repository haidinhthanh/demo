...
def load_data_train():
    x_data = pickle.load(open('data_train/x_data.pkl', 'rb'))
    y_data = pickle.load(open('data_train/y_data.pkl', 'rb'))
    x_test = pickle.load(open('data_train/x_test.pkl', 'rb'))
...
if __name__ == "__main__":
    dir_path = os.path.dirname(os.path.realpath(__file__))
    train_path = os.path.join(dir_path, "data_train/NB classify data/Train_Full")
    test_path = os.path.join(dir_path, "data_train/NB classify data/Test_Full")

    output_train_path_x = os.path.join(dir_path, "data_train/NB classify data/x_data.pkl")
    output_train_path_y = os.path.join(dir_path, "data_train/NB classify data/y_data.pkl")
    output_test_path_x = os.path.join(dir_path, "data_train/NB classify data/x_test.pkl")
    output_test_path_y = os.path.join(dir_path, "data_train/NB classify data/y_test.pkl")
